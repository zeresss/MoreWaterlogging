...
@Mixin({
    AbstractBannerBlock.class, AbstractPressurePlateBlock.class, AbstractButtonBlock.class, AbstractSkullBlock.class,
    ...
    PistonBlock.class, PistonExtensionBlock.class, PistonHeadBlock.class, RedstoneTorchBlock.class, RepeaterBlock.class,
